    ...
    return (
        <div className=" max-w-6xl mx-auto w-11/12 bg-gray-100 p-8 rounded-lg">
            ...
            <div className='flex flex-wrap flex-col md:flex-row justify-between'>
                <WorkCards img={auctiON} altText="auctiON" heading="auctiON"
                ...
                <WorkCards img={BoatDatLife} altText="BoatThatLife" heading="BoatThatLife"
              ...
              <WorkCards img={Museum} altText="Museum" heading="Community Science Museum"
              ...
              <WorkCards img={BeerHelper} altText="Beerhelper" heading="BeerHelper"
              ...
              <WorkCards img={GameHub} altText="GameHub" heading="GameHub"
                         infoEng="First project created. Built with HTML and CSS. Homepage for a fictive gaming website, made for a school exam"
                         infoNor="Mitt første prosjekt. Bygd med HTML og CSS. Hjemmeside for et fiktivt spillnettsted, laget for en skoleeksamen."
                         netlify="https://kind-bell-5815d2.netlify.app/"
                         github="https://github.com/SanderSme/Html-css-CA-Gamehub"/>
              <WorkCards img={ConnectFour} altText="ConnectFour" heading="Connect Four"
